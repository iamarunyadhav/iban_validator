    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto" style="float: right">
          ...
          <li class="nav-item" v-if="!isAuthenticated">
            <router-link class="nav-link text-white fw-bold" to="/register">Sign Up</router-link>
          </li>
          <li class="nav-item" v-if="isAuthenticated">
            <button class="nav-link text-white btn btn-link fw-bold" @click="logout">Logout</button>
          </li>
        </ul>
      </div>
    </div>
